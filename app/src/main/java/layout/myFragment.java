...
import com.abbisqq.fragmentandsurfaceview.LetsDraw;
import com.abbisqq.fragmentandsurfaceview.R;

/**
 * A simple {@link Fragment} subclass.
 * Activities that contain this fragment must implement the
 * {@link myFragment.OnMyFragmentInteractionListener} interface
...
public class myFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        letsDraw = new LetsDraw(getActivity());
    ...
    public void onButtonPressed(Uri uri) {
        if (mListener != null) {
            mListener.OnMyFragmentInteraction(uri);
        }
    }
